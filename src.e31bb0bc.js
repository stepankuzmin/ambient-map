  ...
  define(["exports"], function (t) {
    ...
    var J = function (t) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.postMapLoadEvent = function (t, e) {
        C.EVENTS_URL && C.ACCESS_TOKEN && Array.isArray(t) && t.some(function (t) {
          return U(t) || R(t);
        }) && this.queueRequest({
          id: e,
          timestamp: Date.now()
    ...
    var rt = function (t) {
      function e(e, r, n) {
        401 === r && R(n) && (e += ": you may have provided an invalid Mapbox access token. See https://www.mapbox.com/api-documentation/#access-tokens-and-token-scopes"), t.call(this, e), this.status = r, this.url = n, this.name = this.constructor.name, this.message = e;
      }
    ...
    function Kt(t) {
      var e = typeof t;
      return null === t ? "" : "string" === e || "number" === e || "boolean" === e ? String(t) : t instanceof Dt || t instanceof Rt ? t.toString() : JSON.stringify(t);
    }

    Rt.fromString = function (t) {
      return new Rt([new jt(t, null, null)]);
    ...
    Yt.parse = function (t, e) {
      ...
      return new Rt(this.sections.map(function (e) {
    ...
    $t.parse = function (t, e) {
      ...
      if ("color" === this.type.kind) {
        for (var e, r, n = 0, i = this.args; n < i.length; n += 1) {
          ...
          if ("string" == typeof e) {
            ...
            if (a) return a;
          } else if (Array.isArray(e) && !(r = e.length < 3 || e.length > 4 ? "Invalid rbga value " + JSON.stringify(e) + ": expected an array containing either three or four numeric values." : qt(e[0], e[1], e[2], e[3]))) return new Dt(e[0] / 255, e[1] / 255, e[2] / 255, e[3]);
        }
      ...
      return "formatted" === this.type.kind ? Rt.fromString(Kt(this.args[0].evaluate(t))) : Kt(this.args[0].evaluate(t));
    ...
    function cr(t, e, r) {
      return "color" === e.type ? r = Dt.parse(r) : "formatted" === e.type ? r = Rt.fromString(r.toString()) : ir(r) === e.type || "enum" === e.type && e.values[r] || (r = void 0), sr(r, t.default, e.default);
    }
    ...
    qn.serialize = function (t, e) {
      ...
      this.length = 0;
    }, qn.prototype.resize = function (t) {
      this.reserve(t), this.length = t;
    }, qn.prototype.reserve = function (t) {
      if (t > this.capacity) {
    ...
    }, Ri.prototype.populatePaintArray = function () {}, Ri.prototype.updatePaintArray = function () {}, Ri.prototype.upload = function () {}, Ri.prototype.destroy = function () {}, Ri.prototype.setConstantPatternPositions = function (t, e) {
      this.patternPositions.patternTo = t.tlbr, this.patternPositions.patternFrom = e.tlbr;
    }, Ri.prototype.setUniforms = function (t, e, r, n, i) {
    ...
    qi.prototype.defines = function () {
      return [];
    }, qi.prototype.setConstantPatternPositions = function () {}, qi.prototype.populatePaintArray = function (t, e) {
    ...
    }, qi.prototype.updatePaintArray = function (t, e, r, n) {
    ...
    Gi.createDynamic = function (t, e, r) {
      ...
      for (var a in t.paint._values) if (r(a)) {
        ...
        if (o instanceof Vn && er(o.property.specification)) {
          ...
          if ("cross-faded" === o.property.specification["property-type"] || "cross-faded-data-driven" === o.property.specification["property-type"]) {
            if ("constant" === o.value.kind) n.binders[a] = new Ri(o.value.value, s, u), i.push("/u_" + a);else {
              var p = Hi(a, u, "source");
            ...
            var c = Hi(a, u, "source");
            n.binders[a] = new qi(o.value, s, u, c), i.push("/a_" + a);
          } else {
      ...
      for (var a in t) for (var o = 0, s = this._featureMap.getPositions(+a); o < s.length; o += 1) {
        ...
        for (var p in this.binders) {
          ...
          if (!(c instanceof ji || c instanceof Ri) && !0 === c.expression.isStateDependent) {
            var h = r.paint.get(p);
      ...
      for (var r in this.binders) {
        ...
        if (n instanceof Ki) {
          ...
          i && e.push(i);
        } else (n instanceof qi || n instanceof Ni) && n.paintVertexBuffer && e.push(n.paintVertexBuffer);
      }
      ...
      for (var n in this.binders) {
        ...
        (i instanceof qi || i instanceof Ni) && i.paintVertexBuffer && r.push(i.paintVertexBuffer);
      }
    ...
    }, sn("ConstantBinder", ji), sn("CrossFadedConstantBinder", Ri), sn("SourceExpressionBinder", qi), sn("CrossFadedCompositeBinder", Ki), sn("CompositeExpressionBinder", Ni), sn("ProgramConfiguration", Gi, {
      omit: ["_buffers"]
    ...
    Ra.prototype.resize = function (t) {
      Da(this, t, 4);
        ...
        for (var k = c; k < p; k++) if (!(w = l && k === p - 1 ? t[c + 1] : t[k + 1]) || !t[k].equals(w)) {
          ...
          if (C && "round" === M && (B < a ? M = "miter" : B <= 2 && (M = "fakeround")), "miter" === M && B > i && (M = "bevel"), "bevel" === M && (B > 2 && (M = "flipbevel"), B < i && (M = "miter")), _ && (this.distance += d.dist(_)), "miter" === M) z._mult(B), this.addCurrentVertex(d, this.distance, z, 0, 0, !1, y, u);else if ("flipbevel" === M) {
            ...
            if (L ? (v = 0, m = O) : (m = 0, v = O), b || this.addCurrentVertex(d, this.distance, A, m, v, !1, y, u), "fakeround" === M) {
              ...
              for (var R = D - 1; R >= 0; R--) U = A.mult((R + 1) / (D + 1))._add(S)._unit(), this.addPieSliceVertex(d, this.distance, U, L, y, u);
            }
        ...
        for (var p = e.iconDependencies, c = e.glyphDependencies, h = new Sn(this.zoom), f = 0, y = t; f < y.length; f += 1) {
          ...
          if (r._featureFilter(h, m)) {
            ...
            if (s) {
              ...
              x = vs(b instanceof Rt ? b : Rt.fromString(b), r, m);
            }
    ...
    Ku[10] = !0, Ku[32] = !0, Ku[38] = !0, Ku[40] = !0, Ku[41] = !0, Ku[43] = !0, Ku[45] = !0, Ku[47] = !0, Ku[173] = !0, Ku[183] = !0, Ku[8203] = !0, Ku[8208] = !0, Ku[8211] = !0, Ku[8231] = !0, t.createCommonjsModule = e, t.window = self, t.Point = i, t.browser = V, t.getJSON = function (t, e) {
    ...
    }, t.ResourceType = et, t.getImage = pt, t.RGBAImage = Ra, t.ImagePosition = Us, t.Texture = Xs, t.potpack = Ds, t.normalizeGlyphsURL = function (t, e) {
      if (!U(t)) return t;
      var r = X(t);
      ...
      return n.path = n.path.replace(q, "" + i + a), n.path = "/v4" + n.path, D(n);
    ...
    }, t.WritingMode = Ru, t.transformMat4 = Sa, t.evaluateSizeForFeature = function (t, e, r) {
      var n = e;
    ...
    }, t.ease = u, t.bezier = s, t.config = C, t.webpSupported = M, t.EvaluationParameters = Sn, t.version = "0.53.1", t.setRTLTextPlugin = function (t, e) {
      ...
      var c = qu.fromFeature(t, r);
      p === Ru.vertical && c.verticalizePunctuation();
      var h,
          f = [],
          y = {
        positionedGlyphs: f,
...
_mapboxGl.default.accessToken = "pk.eyJ1Ijoic3RlcGFua3V6bWluIiwiYSI6Ik1ieW5udm8ifQ.25EOEC2-N92NCWT0Ci9w-Q";
const placeIdx = (0, _utils.randomInteger)(0, _places.default.length - 1);
const place = _places.default[placeIdx];
...
function render(swatch) {
  function renderLoop() {
    const color = (0, _randomcolor.default)({
      luminosity: swatch.luminosity
    });
    const duration = (0, _utils.randomInteger)(minDuration, maxDuration);
    setTimeout(() => {
...
_swatches.default.forEach(swatch => {
  const color = (0, _randomcolor.default)({
    luminosity: swatch.luminosity
  });
  const duration = (0, _utils.randomInteger)(minDuration, maxDuration);
...
},{"mapbox-gl":"../node_modules/mapbox-gl/dist/mapbox-gl.js","randomcolor":"../node_modules/randomcolor/randomColor.js","./style":"style.js","./places":"places.json","./swatches":"swatches.js","./utils":"utils.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
